export default {
    '@tags': ['savedSearch'],
    'Create Saved Search via Push Notification (without alert option)': (client) => {
        ...
        leadDetail.changeInputLabelAndLocation("Test 26");
        ...
        leadDetail.expect.element('@reusutlSaveSearchStandard').text.to.equal('Test 26: Stevensville, MD, 1+ Beds, 2+ Baths, 0+ Sqft $1k-$1m');
        client.end();
    }
};